...
if ($uploadOk == 0) {
    ...
    if (move_uploaded_file($_FILES["fileToUpload"]["tmp_name"], $target_file)) {
        ...
        if (!isset($_POST["idproducto"])) {
            ...
            if (isset($_POST["nombreproducto"]) &&  isset($_POST["idcategoria"]) &&  isset($_POST["descripcionproducto"])) {
                ...
                $sql = "insert into producto (idproducto, idcategoria, claveproducto, nombreproducto, descripcionproducto, fechaalta, activo, urlfoto) values(0, " . $_POST["idcategoria"] . ", '" . $claveproducto . "', '" . $_POST["nombreproducto"] . "', '" . $_POST["descripcionproducto"] . "', now(), " . $activo . ", '" . $Fname . "')";
                echo $sql;
